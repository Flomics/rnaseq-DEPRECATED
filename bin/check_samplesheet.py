...
def parse_args(args=None):
    Description = 'Reformat Flomics/SARSCoV2 samplesheet file and check its contents.'
...
#    sraWarningList = []
    while True:
        ...
        if line:
            ...
            if sample and fastq_1 and fastq_2:                              ## Paired-end short reads
                sampleInfoList = [[sample, '0', fastq_1, fastq_2]]

            elif sample and fastq_1 and not fastq_2:                        ## Single-end short reads
                sampleInfoList = [[sample, '1', fastq_1, fastq_2]]

            elif sample and not fastq_1 and not fastq_2:
                print_error("Missing file paths!",line)
                 ## SRA accession
            #    if not skipSRA:
    ...
    fout.write(','.join(['sample_id', 'single_end', 'fastq_1', 'fastq_2']) + '\n')
...
def main(args=None):
    ...
    check_samplesheet(args.FILE_IN,args.OUT_PREFIX)
