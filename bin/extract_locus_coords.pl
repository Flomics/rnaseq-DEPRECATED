...
#######################################################################################
#
# Calculate gene start/end coordinates based on exon coordinates in a GTF
#  Input: GFF/GTF with 'exon' features grouped by 'gene_id' attributes
#  Output: corresponding gene coordinates in BED format (one record per gene_id)
#
#######################################################################################
