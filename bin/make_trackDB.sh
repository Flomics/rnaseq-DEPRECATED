...
echo -e "track $sample_name\nbigDataUrl https://flomics-public.s3.eu-west-1.amazonaws.com/RNAseq_pipeline_trackHubs/${folder_name}/dataFiles/$1\nshortLabel $sample_name\nlongLabel $sample_name sample of the project $project_name\ntype bam\nvisibility full\ndoWiggle on\n" >> ${prefix}_trackDb.txt
echo "http://genome-euro.ucsc.edu/cgi-bin/hgTracks?hubUrl=https://flomics-public.s3.eu-west-1.amazonaws.com/RNAseq_pipeline_trackHubs/${folder_name}/hub.txt" > UCSC.txt
